...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260829084501_AddOwnershipToFolder")]
    partial class AddOwnershipToFolder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.HasIndex("ActorAccountId", "Action", "CreatedAt");
            ...
            modelBuilder.Entity("Domain.Entities.FilePermission", b =>
                {
                    ...
                    b.ToTable("FilePermissions", t =>
                        {
                            t.HasCheckConstraint("CK_FilePermission_OneSubject", "(\"ProjectParticipantId\" IS NOT NULL) <> (\"AccountId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FolderPermission", b =>
                {
                    ...
                    b.ToTable("FolderPermissions", t =>
                        {
                            t.HasCheckConstraint("CK_FolderPermission_OneSubject", "(\"ProjectParticipantId\" IS NOT NULL) <> (\"AccountId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Folder", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ProjectParticipant", "OwnerParticipant")
                        .WithMany()
