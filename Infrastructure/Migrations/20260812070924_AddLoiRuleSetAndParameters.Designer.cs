...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260812070924_AddLoiRuleSetAndParameters")]
    partial class AddLoiRuleSetAndParameters
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Account", b =>
                {
                    ...
                    b.Property<bool>("IsOnboardingEmailPending")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.FileViewGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FileItemId", "AccountId")
                        .IsUnique();

                    b.ToTable("FileViewGrants");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Folder", b =>
                {
                    ...
                    b.Property<Guid?>("MirrorSourceFolderId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.LoiParameter", b =>
                {
                    ...
                    b.HasIndex("RuleSetId", "NameNormalized")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.FileItem", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.FileItem", null)
                        .WithMany()
                        .HasForeignKey("SourceFileItemId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Entities.FileViewGrant", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ApprovalRequest", "SourceApprovalRequest")
                        .WithMany()
                    ...
                    b.Navigation("SourceApprovalRequest");
                });
