...
namespace Application.Interfaces.IServices
{
    public interface IFolderTreeService
    {
        ...
        // Nội dung 1 cấp khi user click vào folder trên cây: TOÀN BỘ subfolder trực tiếp
        // (đã lọc theo quyền View) + 1 trang file của chính folder đó; ném 403 nếu không có quyền View.
        Task<FolderContentsPagedDTO> GetFolderContentsAsync(
