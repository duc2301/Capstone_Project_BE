...
{
    public class FolderPermissionServiceTests
    {
        private readonly Mock<IUnitOfWork> _mockUnitofwork;
        private readonly Mock<IMapper> _mockMapper;
        private readonly FolderPermissionService _service;

        public FolderPermissionServiceTests()
        {
            _mockUnitofwork = new Mock<IUnitOfWork>();
            _mockMapper = new Mock<IMapper>();

            _service = new FolderPermissionService(
