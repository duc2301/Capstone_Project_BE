...
{
    public class FileSignaturePositionServiceTests
    {
        ...
        private readonly FileSignaturePositionService _service;

        public FileSignaturePositionServiceTests()
        {
            ...
            _service = new FileSignaturePositionService(
        ...
        public void Constructor_WithNullDependency_ShouldThrowArgumentNullException()
        {
            ...
            Action act = () => 
                new FileSignaturePositionService(
                    null!,
                    _mockStorage.Object,
                    _mockApprovalservice.Object,
                    _mockOfficeconverter.Object,
