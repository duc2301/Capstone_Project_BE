...
{
    public class FolderBootstrapServiceTests
    {
        private readonly Mock<IUnitOfWork> _mockUnitofwork;
        private readonly Mock<IMapper> _mockMapper;
        private readonly FolderBootstrapService _service;

        public FolderBootstrapServiceTests()
        {
            _mockUnitofwork = new Mock<IUnitOfWork>();
            _mockMapper = new Mock<IMapper>();

            _service = new FolderBootstrapService(
