...
{
    public class FileZoneResolverServiceTests
    {
        private readonly Mock<IUnitOfWork> _mockUnitofwork;
        private readonly FileZoneResolverService _service;

        public FileZoneResolverServiceTests()
        {
            _mockUnitofwork = new Mock<IUnitOfWork>();

            _service = new FileZoneResolverService(
