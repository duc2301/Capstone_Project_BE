...
{
    public class ContractPackageServiceTests
    {
        private readonly Mock<IUnitOfWork> _mockUnitofwork;
        private readonly Mock<IMapper> _mockMapper;
        private readonly ContractPackageService _service;

        public ContractPackageServiceTests()
        {
            _mockUnitofwork = new Mock<IUnitOfWork>();
            _mockMapper = new Mock<IMapper>();

            _service = new ContractPackageService(
