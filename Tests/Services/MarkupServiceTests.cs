...
namespace Capstone_Project.Tests.Services
{
    public class MarkupServiceTests
    {
        ...
        private readonly Mock<IMarkupBroadcaster> _mockBroadcaster;
        private readonly Mock<INotificationService> _mockNotification;
        private readonly MarkupService _service;
        ...
        public MarkupServiceTests()
        {
            ...
            _mockBroadcaster = new Mock<IMarkupBroadcaster>();
            _mockNotification = new Mock<INotificationService>();

            _service = new MarkupService(
